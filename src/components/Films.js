    ...
    render(){
        ...
        return(
            <Router>
                ...
                <Pagination className="pagination" defaultCurrent={1} total={this.props.Value} defaultPageSize={5} onChange={page => {this.props.Func(this.props.type, page-1, this.state.pageSize); window.scrollTo( 0, 0);}} onShowSizeChange={this.onShowSizeChange} pageSizeOptions={[5, 10, 20, 50, 100]}/>
            </div>
          </Router>
        );
    }
